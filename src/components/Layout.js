...
import "./layout.scss"
import logo from "../images/assets/guarapo_logo.svg"
      ...
      <div
        ...
        <footer className="footer">
          <div className="container">
            <div className="footer-text">Copyright &copy; 2014 - {(new Date().getFullYear())} - <a href="https://guarapomedia.com" target="_blank" rel="noopener noreferrer"><img src={logo} className="icon icon-logo" alt="Guarapo Media" /></a></div>
          </div>
        </footer>
      </div>
    )
